...
export declare type UndiscriminatedUnionSchema<Schemas extends [...Schema[]]> = Schema<
...
export declare type inferParsedUnidiscriminatedUnionSchema<Schemas extends [...Schema[]]> = inferParsed<
    Schemas[number]
>;
