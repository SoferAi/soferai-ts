...
export class Health {
     ...
     */
    public async getHealth(requestOptions?: Health.RequestOptions): Promise<SoferAI.HealthResponse> {
        ...
        if (_response.ok) {
            return serializers.HealthResponse.parseOrThrow(_response.body, {
